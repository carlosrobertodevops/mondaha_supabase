    ...
    return FutureBuilder<List<MembrosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        _model.debugBackendQueries[
                'searchPageMembrosRowList_Scaffold_ll3of8x9${searchPageMembrosRowList.length > 100 ? ' (first 100)' : ''}'] =
            debugSerializeParam(
          searchPageMembrosRowList.take(100),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final membros = searchPageMembrosRowList.toList();
                            _model.debugGeneratorVariables[
                                    'membros${membros.length > 100 ? ' (first 100)' : ''}'] =
                                debugSerializeParam(
                              membros.take(100),
                              ParamType.SupabaseRow,
                              isList: true,
                                ...
                                return Padding(
                                  ...
                                  child: FutureBuilder<List<MembrosRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<MembrosRow> userList5MembrosRowList =
                                          snapshot.data!;

                                      _model.debugBackendQueries[
                                              'userList5MembrosRowList_Container_bfp6ojko${userList5MembrosRowList.length > 100 ? ' (first 100)' : ''}'] =
                                          debugSerializeParam(
                                        userList5MembrosRowList.take(100),
                                        ParamType.SupabaseRow,
                                        isList: true,
                                        link:
                                            'https://app.flutterflow.io/project/mondaha-be2293?tab=uiBuilder&page=search_page',
