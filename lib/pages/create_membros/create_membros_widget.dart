                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'cmmw7oq1' /* Create Company Profile */,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'wajv0aoe' /* Upload images about your compa... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'lkp261n5' /* Enter in your website without ... */,
                                              ),
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
