...
import 'main_faccao_list_model.dart';
export 'main_faccao_list_model.dart';

class MainFaccaoListWidget extends StatefulWidget {
  const MainFaccaoListWidget({
    super.key,
    this.addModelFn,
    this.fuccaoid,
  });

  final FuncoesRow? fuccaoid;
  final Function(FlutterFlowModel)? addModelFn;

  @override
  State<MainFaccaoListWidget> createState() => _MainFaccaoListWidgetState();
}

class _MainFaccaoListWidgetState extends State<MainFaccaoListWidget>
    with TickerProviderStateMixin, RouteAware {
  late MainFaccaoListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainFaccaoListModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'main_faccao_list'});
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          if (responsiveVisibility(
                            ...
                            Builder(
                              builder: (context) => FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'MAIN_FACCAO_LIST_ADD_FACTION_BTN_ON_TAP');
                                  await showDialog(
                                    context: context,
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MAIN_FACCAO_LIST_search_rounded_ICN_ON_T');
                                                  ...
                                                  content: FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      _model.debugBackendQueries[
                                                              'listViewFaccoesRowList_ListView_lav60xaa${listViewFaccoesRowList.length > 100 ? ' (first 100)' : ''}'] =
                                                          debugSerializeParam(
                                                        listViewFaccoesRowList
                                                            .take(100),
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_FACCAO_LIST_Icon_ptb3guuh_ON_TAP');
