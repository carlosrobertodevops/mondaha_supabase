                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      Builder(
                                        builder: (context) => FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'MAIN_FACCOES_PAGE_FACTION_ADD_BTN_ON_TAP');
                                            await showDialog(
                                ...
                                Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MAIN_FACCOES_Container_xb52jnww_ON_TAP');
                                        if (MediaQuery.sizeOf(context).width >=
                                          ...
                                          context.pushNamed('project_details');
                                        }
                                      },
                                                            ...
                                                            borderRadius:
                                                                BorderRadius
                                                                    .circular(
                                                                        12.0),
                                                            child: Image.asset(
                                                              'assets/images/Captura_de_tela_2024-09-15_213033.png',
                                                              width: 60.0,
                                                              height: 60.0,
                                                              fit: BoxFit.cover,
                                                            ),
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '8t72ssfn' /* First Capital Command */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium
                                ...
                                Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MAIN_FACCOES_Container_44w0jkj6_ON_TAP');
                                        if (MediaQuery.sizeOf(context).width >=
                                            991.0) {
                                          await showDialog(
                                            barrierColor:
                                                            ...
                                                            borderRadius:
                                                                BorderRadius
                                                                    .circular(
                                                                        12.0),
                                                            child: Image.asset(
                                                              'assets/images/Captura_de_tela_2024-09-15_213158.png',
                                                              width: 60.0,
                                                              height: 60.0,
                                                              fit: BoxFit.cover,
                                                            ),
