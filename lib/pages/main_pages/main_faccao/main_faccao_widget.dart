...
import 'main_faccao_model.dart';
export 'main_faccao_model.dart';

class MainFaccaoWidget extends StatefulWidget {
  const MainFaccaoWidget({
    super.key,
    this.addModelFn,
  ...
  @override
  State<MainFaccaoWidget> createState() => _MainFaccaoWidgetState();
}

class _MainFaccaoWidgetState extends State<MainFaccaoWidget>
    with TickerProviderStateMixin, RouteAware {
  late MainFaccaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainFaccaoModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'main_faccao'});
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MAIN_FACCAO_search_rounded_ICN_ON_TAP');
                                                  ...
                                                  content: FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      _model.debugBackendQueries[
                                                        ...
                                                        isList: true,
                                                        link:
                                                            'https://app.flutterflow.io/project/mondaha-be2293?tab=uiBuilder&page=main_faccao',
                                                        name: 'faccoes',
                                                        nullable: false,
                                                      );
                                                      debugLogWidgetClass(
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_FACCAO_PAGE_Icon_l7akkn5h_ON_TAP');
