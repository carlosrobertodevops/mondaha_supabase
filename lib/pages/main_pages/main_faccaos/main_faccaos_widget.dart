...
import 'main_faccaos_model.dart';
export 'main_faccaos_model.dart';

class MainFaccaosWidget extends StatefulWidget {
  const MainFaccaosWidget({super.key, this.addModelFn});

  final Function(FlutterFlowModel)? addModelFn;

  @override
  State<MainFaccaosWidget> createState() => _MainFaccaosWidgetState();
}

class _MainFaccaosWidgetState extends State<MainFaccaosWidget>
    with TickerProviderStateMixin, RouteAware {
  late MainFaccaosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainFaccaosModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'main_faccaos'});
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MAIN_FACCAOS_search_rounded_ICN_ON_TAP');
                                                  ...
                                                  content: FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      _model.debugBackendQueries[
                                                              'listViewFaccoesRowList_ListView_papz5swd${listViewFaccoesRowList.length > 100 ? ' (first 100)' : ''}'] =
                                                          debugSerializeParam(
                                                        listViewFaccoesRowList
                                                            .take(100),
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_FACCAOS_PAGE_Icon_y0mw3is8_ON_TAP');
