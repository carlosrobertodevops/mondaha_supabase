...
class SupabaseAuthManager extends AuthManager with EmailSignInManager {
  ...
  Future updateEmail({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        'ics1ahz4' /* Email change confirmation emai... */,
      ))),
    );
  }
  ...
  Future resetPassword({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(FFLocalizations.of(context).getText(
        'ddazihx4' /* Password reser email sent! */,
      ))),
    );
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      final authUser = user == null ? null : MordahaSupabaseUser(user);
      ...
      final errorMsg = e.message.contains('User already registered') ?? false
          ? FFLocalizations.of(context).getText(
              'a454xjq7' /* Email already in use by anothe... */,
            )
