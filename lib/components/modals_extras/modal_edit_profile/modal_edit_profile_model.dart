  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetStates: {
          'yourNameText1': debugSerializeParam(
            ...
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/mondaha-be2293?tab=uiBuilder&page=modal_edit_profile',
            name: 'String',
            nullable: true,
          ),
        ...
        link:
            'https://app.flutterflow.io/project/mondaha-be2293/tab=uiBuilder&page=modal_edit_profile',
        searchReference:
            'reference=OhJtb2RhbF9lZGl0X3Byb2ZpbGVQAFoSbW9kYWxfZWRpdF9wcm9maWxl',
        widgetClassName: 'modal_edit_profile',
      );
}
