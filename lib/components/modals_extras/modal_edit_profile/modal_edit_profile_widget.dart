...
class ModalEditProfileWidget extends StatefulWidget {
  const ModalEditProfileWidget({super.key});

  @override
  State<ModalEditProfileWidget> createState() => _ModalEditProfileWidgetState();
}
...
class _ModalEditProfileWidgetState extends State<ModalEditProfileWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalEditProfileModel());
                      ...
                      children: [
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MODAL_EDIT_PROFILE_CANCEL_BTN_ON_TAP');
