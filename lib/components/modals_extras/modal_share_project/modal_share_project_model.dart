  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetStates: {
          'yourNameText': debugSerializeParam(
            ...
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/mondaha-be2293?tab=uiBuilder&page=modal_share_project',
            name: 'String',
            nullable: true,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/mondaha-be2293/tab=uiBuilder&page=modal_share_project',
        searchReference:
            'reference=OhNtb2RhbF9zaGFyZV9wcm9qZWN0UABaE21vZGFsX3NoYXJlX3Byb2plY3Q=',
        widgetClassName: 'modal_share_project',
      );
}
