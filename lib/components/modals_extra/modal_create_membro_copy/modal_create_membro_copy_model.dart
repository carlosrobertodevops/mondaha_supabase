...
import 'modal_create_membro_copy_widget.dart' show ModalCreateMembroCopyWidget;
...
class ModalCreateMembroCopyModel
    extends FlutterFlowModel<ModalCreateMembroCopyWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        localStates: {
          'photoNumber': debugSerializeParam(
            ...
            searchReference:
                'reference=QhoKFAoLcGhvdG9OdW1iZXISBWdsd3NtcgIIAVAAWgtwaG90b051bWJlcmIXbW9kYWxfY3JlYXRlX21lbWJyb0NvcHk=',
            name: 'int',
            nullable: true,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/mondaha-be2293/tab=uiBuilder&page=modal_create_membroCopy',
        searchReference:
            'reference=Ohdtb2RhbF9jcmVhdGVfbWVtYnJvQ29weVAAWhdtb2RhbF9jcmVhdGVfbWVtYnJvQ29weQ==',
        widgetClassName: 'modal_create_membroCopy',
      );
}
