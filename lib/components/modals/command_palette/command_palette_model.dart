  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetStates: {
          'textFieldText': debugSerializeParam(
            ...
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/mondaha-be2293?tab=uiBuilder&page=command_palette',
            name: 'String',
            nullable: true,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/mondaha-be2293/tab=uiBuilder&page=command_palette',
        searchReference:
            'reference=Og9jb21tYW5kX3BhbGV0dGVQAFoPY29tbWFuZF9wYWxldHRl',
        widgetClassName: 'command_palette',
      );
}
