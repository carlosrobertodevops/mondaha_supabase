...
class ModalWelcomeModel extends FlutterFlowModel<ModalWelcomeWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/mondaha-be2293/tab=uiBuilder&page=modal_welcome',
        searchReference:
            'reference=Og1tb2RhbF93ZWxjb21lUABaDW1vZGFsX3dlbGNvbWU=',
        widgetClassName: 'modal_welcome',
      );
}
